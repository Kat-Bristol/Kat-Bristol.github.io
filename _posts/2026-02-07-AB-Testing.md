...
The marketing team is certain that customers who received a mailer (i.e. Groups 1 or 2) signed up to the company's loyalty scheme more than the control group but are unsure whether the quality of mailer they received made a significant difference. We can answer this question using hypothesis testing, in particular using the chi-square test for independence.
